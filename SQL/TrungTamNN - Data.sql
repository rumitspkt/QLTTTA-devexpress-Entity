-- Data
-- KHOAHOC
insert into KhoaHoc values (1,TO_DATE('2017-03-10', 'YYYY-MM-DD') ,15,'Hoan Thanh');
insert into KhoaHoc values (2,TO_DATE('2017-07-10', 'YYYY-MM-DD') ,15,'Chua Hoan Thanh');
-- MONHOC
...
-- Info
insert into GiangVien values (1,'John Rune',TO_DATE('1990-02-17', 'YYYY-MM-DD'),8,'Thac Si',10000000,'gv1@abc.com');
insert into GiangVien values (2,'Mary Sue',TO_DATE('1987-05-8', 'YYYY-MM-DD'),12,'Thac Si',11000000,'gv2@abc.com');
insert into GiangVien values (3,'Ben Watson',TO_DATE('1988-11-21', 'YYYY-MM-DD'),8,'Thac Si',13000000,'gv3@abc.com');
insert into GiangVien values (4,'Michael John',TO_DATE('1992-01-18', 'YYYY-MM-DD'),7,'Thac Si',9000000,'gv4@abc.com');
insert into GiangVien values (5,'Adam Mills',TO_DATE('1991-01-26', 'YYYY-MM-DD'),11,'Thac Si',10000000,'gv5@abc.com');
insert into GiangVien values (6,'Scott Parker',TO_DATE('1993-03-19', 'YYYY-MM-DD'),8,'Thac Si',9000000,'gv6@abc.com');
insert into GiangVien values (7,'Peter Parker',TO_DATE('1994-10-07', 'YYYY-MM-DD'),8,'Thac Si',9000000,'gv7@abc.com');
insert into GiangVien values (8,'Tony Stark',TO_DATE('1993-05-21', 'YYYY-MM-DD'),7,'Thac Si',9000000,'gv8@abc.com');
-- NHANVIEN
-- Mail
...
-- Info
insert into NhanVien values (1,'Tran Dieu Linh',TO_DATE('1990-02-17', 'YYYY-MM-DD'),'Nu','341932010',7000000,'nv1@abc.com');
insert into NhanVien values (2,'Nguyen Thi Phuong',TO_DATE('1990-02-17', 'YYYY-MM-DD'),'Nu','341925054',7000000,'nv2@abc.com');
insert into NhanVien values (3,'Nguyen Hoang Nam',TO_DATE('1990-02-17', 'YYYY-MM-DD'),'Nam','341923064',7000000,'nv3@abc.com');
insert into NhanVien values (4,'Tran Quoc Tuan',TO_DATE('1990-02-17', 'YYYY-MM-DD'),'Nam','341932063',7000000,'nv4@abc.com');
-- HOCVIEN
insert into HocVien values (1,'Le Vinh Trung',TO_DATE('1997-03-10', 'YYYY-MM-DD'),'Nam','Thu Duc','0909684578');
insert into HocVien values (2,'Nguyen Rum',TO_DATE('1998-05-15', 'YYYY-MM-DD'),'Nam','Binh Thanh','0907456821');
insert into HocVien values (3,'Huynh Uyen Phuong',TO_DATE('1997-04-21', 'YYYY-MM-DD'),'Nu','Tan Phu','0907852963');
insert into HocVien values (4,'Le Vu Hoang Hiep',TO_DATE('1997-06-07', 'YYYY-MM-DD'),'Nam','Thu Duc','0983147598');
insert into HocVien values (5,'Ngo Van Huy',TO_DATE('1997-03-10', 'YYYY-MM-DD'),'Nam','Tan Binh','0902358854');
insert into HocVien values (6,'Nguyen Thuy Uyen',TO_DATE('1997-06-12', 'YYYY-MM-DD'),'Nu','Quan 1','0981471517');
insert into HocVien values (7,'Le Phuong Thao',TO_DATE('1997-08-08', 'YYYY-MM-DD'),'Nu','Quan 9','0942365985');
insert into HocVien values (8,'Nguyen Thanh Son',TO_DATE('1997-09-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0978415235');
insert into HocVien values (9,'Nguyen Quang Hai',TO_DATE('1997-10-08', 'YYYY-MM-DD'),'Nam','Quan 9','0908365985');
insert into HocVien values (10,'Vu Van Thanh',TO_DATE('1997-11-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0993415235');
insert into HocVien values (11,'Nguyen Thuy Uyen',TO_DATE('1997-06-12', 'YYYY-MM-DD'),'Nu','Quan 1','0981471512');
insert into HocVien values (12,'Le Thao',TO_DATE('1997-08-08', 'YYYY-MM-DD'),'Nu','Quan 9','0942365958');
insert into HocVien values (13,'Nguyen Son',TO_DATE('1997-09-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0978415244');
insert into HocVien values (14,'Bui Tien Dung',TO_DATE('1997-10-08', 'YYYY-MM-DD'),'Nam','Quan 9','0908365910');
insert into HocVien values (15,'Nguyen Trong Dai',TO_DATE('1997-11-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0993415115');
insert into HocVien values (16,'Nguyen Viet Thang',TO_DATE('1997-03-10', 'YYYY-MM-DD'),'Nam','Thu Duc','0903684578');
insert into HocVien values (17,'Nguyen Thanh Nha',TO_DATE('1998-05-15', 'YYYY-MM-DD'),'Nam','Binh Thanh','0989335412');
insert into HocVien values (18,'Nguyen Thi Y Nhi',TO_DATE('1997-04-21', 'YYYY-MM-DD'),'Nu','Tan Phu','0987852365');
insert into HocVien values (19,'Pham Dang Hiep',TO_DATE('1997-06-07', 'YYYY-MM-DD'),'Nam','Thu Duc','0981417845');
insert into HocVien values (20,'Ngo Van Hung',TO_DATE('1997-03-10', 'YYYY-MM-DD'),'Nam','Tan Binh','0986412557');
insert into HocVien values (21,'Nguyen Phuong Nhu',TO_DATE('1997-06-12', 'YYYY-MM-DD'),'Nu','Quan 1','0951245874');
insert into HocVien values (22,'Le Thi Phuong Thao',TO_DATE('1997-08-08', 'YYYY-MM-DD'),'Nu','Quan 9','0982165985');
insert into HocVien values (23,'Nguyen Son Thanh',TO_DATE('1997-09-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0978455235');
insert into HocVien values (24,'Nguyen Minh Phuong',TO_DATE('1997-10-08', 'YYYY-MM-DD'),'Nam','Quan 9','0908295985');
insert into HocVien values (25,'Vu Van Thanh',TO_DATE('1997-11-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0908615235');
insert into HocVien values (26,'Nguyen Thi Thuy ',TO_DATE('1997-06-12', 'YYYY-MM-DD'),'Nu','Quan 1','0981491512');
insert into HocVien values (27,'Le Thao',TO_DATE('1997-08-08', 'YYYY-MM-DD'),'Nu','Quan 9','0957365668');
insert into HocVien values (28,'Nguyen Son',TO_DATE('1997-09-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0909468244');
insert into HocVien values (29,'Ha Duc Chinh',TO_DATE('1997-10-08', 'YYYY-MM-DD'),'Nam','Quan 9','0981655910');
insert into HocVien values (30,'Nguyen Cong Phuong',TO_DATE('1997-11-02', 'YYYY-MM-DD'),'Nam','Thu Duc','0908444115');
-- KHOAHOC 1
-- LOPHOC
-- Toeic
